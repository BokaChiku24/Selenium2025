...
public class AutoSuggestiveDropdownNew {
    @Test
    public void testAutoSuggestiveDropdown(){
        ...
        List<WebElement> autoSuggestiveDropdown = driver.findElements(By.cssSelector("ul[id='ui-id-1'] li a"));
        for(WebElement list : autoSuggestiveDropdown){
